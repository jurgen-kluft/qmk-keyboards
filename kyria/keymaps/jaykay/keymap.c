...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_Z, KC_X, KC_C,    KC_V,    KC_B,    CC_PDT,         CC_NDT,    KC_N,    KC_M,     KC_COMMA, KC_DOT, OSL_LN,   
                OSL_LN, OSL_LN, CC_FNAV, KC_SPACE,       KC_BSPC, CC_FSYM, CW_TOGG, CW_TOGG                   
    ),
    [LAYER_RSTHD] = LAYOUTX(
    KC_J,    KC_C, KC_Y,    KC_F,    KC_K,                            KC_Z,    KC_L,     KC_BSPC, KC_U,   KC_Q,  
    KC_R,    KC_S, KC_T,    KC_H,    KC_D,                            KC_M,    KC_N,     KC_A,      KC_I,   KC_O,  
    KC_SCLN, KC_V, KC_G,    KC_P,    KC_B,    CC_PDT,         CC_NDT, KC_X,    KC_W,     KC_COMMA,  KC_DOT, OSL_LN, 
                   OSL_LN, OSL_LN, CC_FNAV, KC_SPACE,       KC_E,   CC_FSYM, CW_TOGG, CW_TOGG                  
    ),
    ...
    KC_4,    KC_3,     KC_2,    KC_1,     KC_ASTR, KC_NO,          KC_NO,     KC_B,    KC_UNDS,  KC_COMMA, KC_DOT, OSL_LN, 
                       OSL_LN, OSL_LN,  CC_FNAV, KC_SPACE,       KC_BSPC, CC_FSYM, CW_TOGG, CW_TOGG                 
    ),
    [LAYER_SYMBOLS] = LAYOUTX(
    KC_PERC, KC_AMPR,  KC_PIPE, KC_UNDS,   KC_TILD,                            KC_GRV,  KC_QUOT,  KC_DQUO,  KC_HASH, KC_DLR,  
    KC_EXLM, KC_MINUS, KC_PLUS, KC_EQUAL,  KC_LBRC,                            KC_RBRC, KC_RPRN,  KC_LPRN,  KC_SCLN, KC_COLN, 
    KC_CIRC, KC_SLASH, KC_ASTR, KC_BSLS,   KC_LABK, CC_NDOC,        CC_PDOC,   KC_RABK, KC_RCBR,  KC_LCBR,  KC_QUES, KC_AT,   
                       KC_NO,   KC_NO,     CC_FNAV, KC_SPACE,       KC_BSPC, CC_FSYM, KC_NO,    KC_NO
    ),
    [LAYER_NAVIGATION] = LAYOUTX(
    CC_REDO, CC_CLOSE, KC_ESCAPE, KC_ENTER, KC_TAB,                               KC_INSERT, CC_PGUP,   KC_HOME,  KC_PSCR,  KC_NO, 
    CC_CMD,  CC_ALT,   CC_CTRL,   CC_SHFT,  KC_DELETE,                            KC_LEFT,   KC_DOWN,   KC_UP,    KC_RIGHT, KC_NO, 
    CC_UNDO, CC_CUT,   CC_COPY,   CC_PASTE, KC_NO,     CC_NAPP,        CC_PAPP,   KC_APP,    CC_PGDOWN, KC_END,   KC_NO,    KC_NO, 
                       OSL_LN,   OSL_LN,  CC_FNAV,   KC_SPACE,       KC_BSPC, CC_FSYM,   CW_TOGG,  CW_TOGG                   
    ),
    [LAYER_RAISE] = LAYOUTX(
