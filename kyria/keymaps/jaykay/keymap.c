...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM] = LAYOUT(
    ...
    xxxx, KC_CIRC, KC_SLASH, KC_ASTR, KC_BSLASH, KC_RBRC, ____, xxxx,   xxxx, KC_OS_PDT, SH_TG,   KC_RPRN, KC_RCBR, KC_QUES, KC_AT,   xxxx, 
                             ____,    ____,      ____,    ____, xxxx,   xxxx, ____,      ____,    ____,    ____                             
  ),
  [_NAV] = LAYOUT(
    ...
    xxxx, KC_OS_UNDO, KC_OS_CUT,   KC_OS_COPY, KC_OS_PASTE, SH_TG,     KC_OS_NDT, xxxx,   xxxx, ____,      KC_TRANS,  KC_PGDOWN, KC_END,  KC_NO,    KC_NO, xxxx, 
                                   ____,       ____,        ____,      ____,      xxxx,   xxxx, KC_BSPACE, ____,      ____,      ____                            
  ),
  [_RAISE] = LAYOUT(
