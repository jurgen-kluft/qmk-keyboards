...
const uint8_t PROGMEM user_kb_layers[][40] = {
    ...
    CC_VIM_ZOOM, CC_VIM_CUT,   CC_VIM_CHANGE, CC_VIM_VISUAL, CC_NO,         CC_NO,       CC_NO,   CC_NO,        CC_VIM_DELI, CC_VIM_CLEAR,  CC_VIM_REPEAT, CC_NO,       
                               CC_FNUM,       CC_FNUM,       CC_VIM_RAISE,  CC_NO,       CC_NO,   CC_VIM_RAISE, CC_FCAPS,    CC_FCAPS                                   
    )
};
// clang-format on
