...
#define LAYOUT( \
    ...
    L28, L29, L30, L31, L32, L33, L34,             L35, L36, L37, L38, L39, L40, L41, \
...
const uint8_t PROGMEM user_kb_layers[][72] = {
  [LAYER_QWERTY] = LAYOUT(
   ...
   TC_NO, TC_A,  TC_S,  TC_D,    TC_F,     TC_G,   CC_PDT,   CC_NDT, TC_H,   TC_J,      TC_K,     TC_L,   TC_SCLN,  TC_NO,    
  ...
  [LAYER_NUMBERS] = LAYOUT(
   ...
   TC_NO, TC_PLUS, TC_MINUS, TC_ASTR, TC_SLASH, TC_NO, TC_NO,   TC_NO, TC_6,  TC_0,      TC_9,     TC_8,   TC_7,  TC_NO, 
   TC_NO, TC_7,    TC_8,     TC_9,    TC_0,     TC_6,  TC_NO,   TC_NO, TC_5,  TC_1,      TC_2,     TC_3,   TC_4,  TC_NO, 
   TC_NO, CC_CMD,  CC_ALT,   CC_CTRL, CC_SHFT,  TC_NO,                 TC_NO, TC_EQUAL,  TC_COMMA, TC_DOT, TC_NO, TC_NO, 
   TC_NO, TC_NO,   TC_NO,    CC_FNUM, TC_NO,    TC_NO,                 TC_NO, TC_NO,     TC_NO,    TC_NO,  TC_NO, TC_NO, 
                                      TC_SPACE, TC_NO, TC_NO,   TC_NO, TC_NO, TC_BSPACE                                  
  ),
  [LAYER_SYMBOLS] = LAYOUT(
   TC_NO, TC_NO,   TC_NO,    TC_NO,   TC_NO,     TC_NO,   TC_NO,   TC_NO, TC_NO,   TC_NO,     TC_NO,    TC_NO,   TC_NO,   TC_NO,     
   TC_NO, TC_PERC, TC_AMPR,  TC_PIPE, TC_UNDS,   TC_TILD, TC_NO,   TC_NO, TC_GRV,  TC_QUOT,   TC_DQUO,  TC_HASH, TC_DLR,  TC_NO,     
   TC_NO, TC_EXLM, TC_MINUS, TC_PLUS, TC_EQUAL,  TC_LBRC, TC_NO,   TC_NO, TC_LABK, TC_LPRN,   TC_LCBR,  TC_RABK, TC_COLN, TC_NO,     
   TC_NO, TC_CIRC, TC_SLASH, TC_ASTR, TC_BSLASH, TC_RBRC,                 TC_NO,   TC_RPRN,   TC_RCBR,  TC_QUES, TC_AT,   TC_NO,     
   TC_NO, TC_NO,   TC_NO,    CC_FNUM, CC_FNAV,   CC_PAPP,                 CC_NAPP, CC_FSYM,   CC_FCAPS, TC_NO,   TC_NO,   CC_QWERTY, 
                                      TC_SPACE,  TC_NO,   TC_NO,   TC_NO, TC_NO,   TC_BSPACE                                         
  ),
  ...
  [LAYER_GAMEL] = LAYOUT(
   ...
   TC_ESCAPE, TC_A,  TC_S,     TC_D,     TC_F,     TC_G,      TC_NO,   TC_NO, TC_H,  TC_J,    TC_K,      TC_L,   TC_SCLN,  TC_NO,    
  ...
  [LAYER_GAMER] = LAYOUT(
   ...
   TC_ESCAPE, TC_SCLN,  TC_L,   TC_K,     TC_J,     TC_H,      TC_NO,   TC_NO, TC_H,  TC_J,    TC_K,     TC_L,   TC_SCLN,  TC_NO,     
