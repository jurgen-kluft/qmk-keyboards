...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL, KC_Z, KC_X, KC_C,    KC_V,    KC_B,    CC_PDT,         CC_NDT,    KC_N,    KC_M,     KC_COMMA, KC_DOT,   KC_SLSH,  KC_RCTL,
                         CC_FNUM, CC_FNUM, CC_FNAV, KC_SPACE,       KC_BSPC,   CC_FSYM, CC_FCAPS, CC_FCAPS                   
    ),
    ...
    KC_LCTL, KC_CIRC, KC_SLSH,  KC_ASTR, KC_BSLS,   KC_RBRC, CC_NDOC,        CC_PDOC,   KC_RABK, KC_RPRN, KC_RCBR, KC_QUES,  KC_AT,      KC_RCTL,
    ...
    KC_LCTL, CC_UNDO, CC_CUT,   CC_COPY,   CC_PASTE, KC_BSPC, CC_NAPP,        CC_PAPP,     KC_NO,     CC_PGDOWN, KC_END,   KC_NO,    KC_NO,    KC_RCTL,
                                CC_FNUM,   CC_FNUM,  CC_FNAV, KC_SPACE,       KC_BSPC,     CC_FSYM,   CC_FCAPS,  CC_FCAPS                   
    ),
